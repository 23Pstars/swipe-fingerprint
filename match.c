...
int main(int argc, char *argv[]) {
    ...
    sprintf(file1, "%s%s/HA/HAL%s00%s.bmp", RECONSTRUCTED_DIR, argv[1], argv[2], argv[3]);
    sprintf(file2, "%s%s/HA/HAL%s00%s.bmp", RECONSTRUCTED_DIR, argv[1], argv[4], argv[5]);
...
//    printf("HAL%s00%s.bmp vs HAL%s00%s.bmp: %d\n", argv[2], argv[3], argv[4], argv[5], GMFAPI_Matching(pFD_1, pFD_2));
